...
impl Parsed {
    ...
    /// # Errors
    ///
    /// Returns [`Error::InvalidArgument`] if `value` is outside the range of an `i32`.
    ///
    ...
    /// # Errors
    ///
    /// Returns [`Error::InvalidArgument`] if `value` is negative or if it is greater than `i32::MAX`.
    ///
    /// Returns [`Error::Inconsistent`] if this field was already set to a different value.
    #[inline]
    ...
    /// # Errors
    ///
    /// Return [`Error::InvalidArgument`] if `value` is negative or if it is greater than 99.
    ///
    /// Returns [`Error::Inconsistent`] if this field was already set to a different value.
    #[inline]
    ...
    /// # Errors
    ///
    /// Returns [`Error::InvalidArgument`] if `value` is negative or if it is greater than 99.
    ///
    /// Returns [`Error::Inconsistent`] if this field was already set to a different value.
    #[inline]
    ...
    /// # Errors
    ///
    /// Returns [`Error::InvalidArgument`] if `value` is not in the range 1-12.
    ///
    /// Returns [`Error::Inconsistent`] if this field was already set to a different value.
    #[inline]
    ...
    /// # Errors
    ///
    /// Returns [`Error::InvalidArgument`] if `value` is not in the range 0-53.
    ///
    /// Returns [`Error::Inconsistent`] if this field was already set to a different value.
    #[inline]
    ...
    /// # Errors
    ///
    /// Returns [`Error::InvalidArgument`] if `value` is not in the range 1-53.
    ///
    /// Returns [`Error::Inconsistent`] if this field was already set to a different value.
    #[inline]
    ...
    /// # Errors
    ///
    /// Returns [`Error::InvalidArgument`] if `value` is not in the range 1-366.
    ///
    /// Returns [`Error::Inconsistent`] if this field was already set to a different value.
    #[inline]
    ...
    /// # Errors
    ///
    /// Returns [`Error::InvalidArgument`] if `value` is not in the range 1-31.
    ///
    /// Returns [`Error::Inconsistent`] if this field was already set to a different value.
    #[inline]
    ...
    /// # Errors
    ///
    /// May return [`Error::InvalidArgument`] if `value` is not in the range 0-23.
    ...
    /// # Errors
    ///
    /// Returns [`Error::InvalidArgument`] if `value` is not in the range 0-59.
    ///
    /// Returns [`Error::Inconsistent`] if this field was already set to a different value.
    #[inline]
    ...
    /// # Errors
    ///
    /// Returns [`Error::InvalidArgument`] if `value` is not in the range 0-60.
    ///
    /// Returns [`Error::Inconsistent`] if this field was already set to a different value.
    #[inline]
    ...
    /// # Errors
    ///
    /// Returns [`Error::InvalidArgument`] if `value` is not in the range 0-999,999,999.
    ///
    /// Returns [`Error::Inconsistent`] if this field was already set to a different value.
    #[inline]
    ...
    /// # Errors
    ///
    /// Returns [`Error::InvalidArgument`] if `value` is ouside the range of an `i32`.
    ///
    /// Returns [`Error::Inconsistent`] if this field was already set to a different value.
    #[inline]
...
mod tests {
    ...
    fn test_parsed_set_fields() {
        ...
        let mut p = Parsed::new();
        assert_eq!(p.set_year_div_100(-1), Err(Error::InvalidArgument));
        assert_eq!(p.set_year_mod_100(-1), Err(Error::InvalidArgument));
        assert!(p.set_year(-1).is_ok());
        assert_eq!(p.set_year(-2), Err(Error::Inconsistent));
        assert_eq!(p.set_year(0), Err(Error::Inconsistent));

        let mut p = Parsed::new();
        assert_eq!(p.set_year_div_100(0x1_0000_0008), Err(Error::InvalidArgument));
        ...
        assert_eq!(p.set_month(0x1_0000_0008), Err(Error::InvalidArgument));
        ...
        assert_eq!(p.set_hour12(0), Err(Error::InvalidArgument)); // requires canonical representation
    ...
    fn test_parsed_set_range() {
        assert_eq!(Parsed::new().set_year(i32::MIN as i64 - 1), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_year(i32::MIN as i64).is_ok());
        assert!(Parsed::new().set_year(i32::MAX as i64).is_ok());
        assert_eq!(Parsed::new().set_year(i32::MAX as i64 + 1), Err(Error::InvalidArgument));

        assert_eq!(Parsed::new().set_year_div_100(-1), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_year_div_100(0).is_ok());
        assert!(Parsed::new().set_year_div_100(i32::MAX as i64).is_ok());
        assert_eq!(
            Parsed::new().set_year_div_100(i32::MAX as i64 + 1),
            Err(Error::InvalidArgument)
        );

        assert_eq!(Parsed::new().set_year_mod_100(-1), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_year_mod_100(0).is_ok());
        assert!(Parsed::new().set_year_mod_100(99).is_ok());
        assert_eq!(Parsed::new().set_year_mod_100(100), Err(Error::InvalidArgument));

        assert_eq!(Parsed::new().set_isoyear(i32::MIN as i64 - 1), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_isoyear(i32::MIN as i64).is_ok());
        assert!(Parsed::new().set_isoyear(i32::MAX as i64).is_ok());
        assert_eq!(Parsed::new().set_isoyear(i32::MAX as i64 + 1), Err(Error::InvalidArgument));

        assert_eq!(Parsed::new().set_isoyear_div_100(-1), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_isoyear_div_100(0).is_ok());
        assert!(Parsed::new().set_isoyear_div_100(99).is_ok());
        assert_eq!(
            Parsed::new().set_isoyear_div_100(i32::MAX as i64 + 1),
            Err(Error::InvalidArgument)
        );

        assert_eq!(Parsed::new().set_isoyear_mod_100(-1), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_isoyear_mod_100(0).is_ok());
        assert!(Parsed::new().set_isoyear_mod_100(99).is_ok());
        assert_eq!(Parsed::new().set_isoyear_mod_100(100), Err(Error::InvalidArgument));

        assert_eq!(Parsed::new().set_month(0), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_month(1).is_ok());
        assert!(Parsed::new().set_month(12).is_ok());
        assert_eq!(Parsed::new().set_month(13), Err(Error::InvalidArgument));

        assert_eq!(Parsed::new().set_week_from_sun(-1), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_week_from_sun(0).is_ok());
        assert!(Parsed::new().set_week_from_sun(53).is_ok());
        assert_eq!(Parsed::new().set_week_from_sun(54), Err(Error::InvalidArgument));

        assert_eq!(Parsed::new().set_week_from_mon(-1), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_week_from_mon(0).is_ok());
        assert!(Parsed::new().set_week_from_mon(53).is_ok());
        assert_eq!(Parsed::new().set_week_from_mon(54), Err(Error::InvalidArgument));

        assert_eq!(Parsed::new().set_isoweek(0), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_isoweek(1).is_ok());
        assert!(Parsed::new().set_isoweek(53).is_ok());
        assert_eq!(Parsed::new().set_isoweek(54), Err(Error::InvalidArgument));

        assert_eq!(Parsed::new().set_ordinal(0), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_ordinal(1).is_ok());
        assert!(Parsed::new().set_ordinal(366).is_ok());
        assert_eq!(Parsed::new().set_ordinal(367), Err(Error::InvalidArgument));

        assert_eq!(Parsed::new().set_day(0), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_day(1).is_ok());
        assert!(Parsed::new().set_day(31).is_ok());
        assert_eq!(Parsed::new().set_day(32), Err(Error::InvalidArgument));

        assert_eq!(Parsed::new().set_hour12(0), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_hour12(1).is_ok());
        assert!(Parsed::new().set_hour12(12).is_ok());
        assert_eq!(Parsed::new().set_hour12(13), Err(Error::InvalidArgument));

        assert_eq!(Parsed::new().set_hour(-1), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_hour(0).is_ok());
        assert!(Parsed::new().set_hour(23).is_ok());
        assert_eq!(Parsed::new().set_hour(24), Err(Error::InvalidArgument));

        assert_eq!(Parsed::new().set_minute(-1), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_minute(0).is_ok());
        assert!(Parsed::new().set_minute(59).is_ok());
        assert_eq!(Parsed::new().set_minute(60), Err(Error::InvalidArgument));

        assert_eq!(Parsed::new().set_second(-1), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_second(0).is_ok());
        assert!(Parsed::new().set_second(60).is_ok());
        assert_eq!(Parsed::new().set_second(61), Err(Error::InvalidArgument));

        assert_eq!(Parsed::new().set_nanosecond(-1), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_nanosecond(0).is_ok());
        assert!(Parsed::new().set_nanosecond(999_999_999).is_ok());
        assert_eq!(Parsed::new().set_nanosecond(1_000_000_000), Err(Error::InvalidArgument));

        assert!(Parsed::new().set_timestamp(i64::MIN).is_ok());
        assert!(Parsed::new().set_timestamp(i64::MAX).is_ok());

        assert_eq!(Parsed::new().set_offset(i32::MIN as i64 - 1), Err(Error::InvalidArgument));
        assert!(Parsed::new().set_offset(i32::MIN as i64).is_ok());
        assert!(Parsed::new().set_offset(i32::MAX as i64).is_ok());
        assert_eq!(Parsed::new().set_offset(i32::MAX as i64 + 1), Err(Error::InvalidArgument));
    }
